...
def test_gated_system():
    """Test the gated analysis system."""
    print('🧪 Testing Gated Analysis System')
    print('=' * 50)
    
    # Test with different lookback periods to trigger gates
    test_cases = [
    ...
    for ticker, lookback in test_cases:
        ...
        try:
            results = system.analyze_ticker(ticker, lookback)
