...
def test_csv_import():
    ...
    try:
        ...
        if imported_positions:
            ...
            # Save to JSON file
            output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_imported_portfolio.json")
...
def test_csv_export():
    ...
    try:
        # Export to CSV
        output_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_portfolio_export.csv")
